...
{ "San_Fierro", "Centar,_Glavni_Grad", -2997.40, -1115.50, -242.90, -1213.90, 0xFF0000FF }
};
...
public CreateTextDraws(playerid) {
	...
	p_LocationTextdraw[playerid][0] = CreatePlayerTextDraw(playerid, 129.449325, 418.700775, "Montrey_Community");
	...
	p_LocationTextdraw[playerid][1] = CreatePlayerTextDraw(playerid, 128.343750, 428.600616, "Nepoznato,_Van_radara");
	PlayerTextDrawLetterSize(playerid, p_LocationTextdraw[playerid][1], 0.211654, 1.185832);
	PlayerTextDrawAlignment(playerid, p_LocationTextdraw[playerid][1], 2);
	...
	p_DirectionTextdraw[playerid] = CreatePlayerTextDraw(playerid, 183.968872, 421.417358, "N");
	PlayerTextDrawLetterSize(playerid, p_DirectionTextdraw[playerid], 0.291303, 1.594166);
...
public OnPlayerEnterDynamicArea(playerid, areaid) {
	...
	// Za bunker jer ne moze da se hook izbacuje warn
