...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 27, 2023 at 07:26 PM
...
--
-- Table structure for table `player_fitness`
--

CREATE TABLE `player_fitness` (
  `pID` int(11) NOT NULL,
  `pWalkStyle` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `player_fitness`
--

INSERT INTO `player_fitness` (`pID`, `pWalkStyle`) VALUES
(1, 5),
(2, 4),
(3, 9),
(6, 5);
...
--
-- Indexes for table `player_fitness`
--
ALTER TABLE `player_fitness`
  ADD UNIQUE KEY `player_id` (`pID`);
