...
*/
new SafeZonaKreira[MAX_PLAYERS],
	SafeZonaKreiraID[MAX_PLAYERS];
...
new SafeZone[MAX_SAFEZONA][S_Safe];
new Iterator:SafeZone<MAX_SAFEZONA>;
...
hook OnPlayerKeyStateChange(playerid, KEY:newkeys, KEY:oldkeys)
{
	if(newkeys & KEY_FIRE)
	{
		if(SafeZonaKreira[playerid] == 1)
		{
			...
			SafeZonaKreira[playerid]++;
		}
		else if(SafeZonaKreira[playerid] == 2)
		{
			new Float:Pozicija[4];
			GetPlayerPos(playerid, Pozicija[0],Pozicija[1],Pozicija[2]);
			GetPlayerFacingAngle(playerid, Pozicija[3]);

			new id = SafeZonaKreiraID[ playerid ];
		...
		else if(SafeZonaKreira[playerid] == 3)
		{
			new id = SafeZonaKreiraID[ playerid ];
			new Float:Pozicija[3];
			GetPlayerPos(playerid, Pozicija[0],Pozicija[1],Pozicija[2]);
