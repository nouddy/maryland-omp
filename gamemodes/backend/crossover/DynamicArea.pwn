...
// Bunker
	...
	foreach(new s : SafeZone)
	{
		...
		{
            PlayerTextDrawSetString(playerid, Player_TDs[playerid][7], "SAFE");
...
// Bunker    
	...
	foreach(new i : SafeZone)
	{
		...
		{
            PlayerTextDrawSetString(playerid, Player_TDs[playerid][7], "UNSAFE");
