...
public SQL_AccountDocumentsLoad(playerid)
{
    ...
    if(!rows) 
    {
        ...
        mysql_format(SQL, q, sizeof(q), 
           "INSERT INTO `player_documents` (player_id, NationalID, Passport, VoziloLicence, MotoLicence, BrodLicence, OruzjeLicence) \ 
            VALUES('%d', '0', '0', '0', '0', '0', '0')", PlayerInfo[playerid][SQLID]);
        mysql_tquery(SQL, q);
    }
    else 
    {
